                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                            <template
                                                x-for="category in pro.category"
                                                :key="category"
                                            >
                                                <span
                                        ...
                                        <div
                                            ...
                                            :class="{'text-xs': pro.download_url}"
                                        >
                                            <a
                                                :href="pro.link"
                                                target="_blank"
                                            ...
                                            >
                                                <i
                                                    class="inline-block mx-1 fas fa-link"
                                                ></i>
                                                <span
                                                    x-text="$t('home.project.visit')"
                                                ></span>
                                            </a>
                                            <button
                                            ...
                                            >
                                                <i class="fas fa-at"></i>
                                                <span
                                                    x-text="$t('home.project.moreInfo')"
                                                ></span>
                                            </button>
                                            <template
                                                x-if="pro.download_url.length > 1"
                                            >
                                                <a
                                                    :href="pro.download_url"
                                                    target="_blank"
                                                ...
                                                >
                                                    ...
                                                    ></i>
                                                    <span
                                                        x-text="$t('home.project.download')"
                                                    ></span>
                                                </a>
                                            </template>
                                        </div>
